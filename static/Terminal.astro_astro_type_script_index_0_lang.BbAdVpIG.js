const t={name:"costa",role:"Freelance Developer",love:"Coding for fun",discord:{link:"https://discord.com/users/1426289285551755284",username:"costaffxx"},telegram:{link:"https://t.me/costaffxx/",username:"costaffxx"},email:"csakiny@gmail.com",skills:{languages:["JavaScript","TypeScript","Python","C/C++","C#","Go","Rust","Java","Kotlin","ASM","Lua","SQL"],frontend:["React","Vue.js","Next.js","Tailwind CSS","Astro","Svelte"],backend:["Node.js","MongoDB","MySQL","PostgreSQL","Redis"],tools:["Git","Docker","VS Code","AWS","Figma"]}},s=document.getElementById("cmd-input"),r=document.getElementById("cmd-display"),p=document.getElementById("output"),u=document.getElementById("terminal-content");let d=[],l=-1;const L=`
        <div class="my-2">
            ...
            <div><span class="text-[#7fa4ea] font-bold">${t.name}</span>@<span class="text-[#7fa4ea] font-bold">root</span></div>
            ...
            <div><span class="text-[#7fa4ea]">Telegram</span>: <a href="${t.telegram.link}" target="_blank" class="hover:underline text-white">${t.telegram.username}</a></div>
